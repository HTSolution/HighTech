...
// Abbiamo sostituito le statistiche generiche con la vostra vera forza: il team.
// Ho mantenuto "Anni di Esperienza" aggiornandolo a "20+" visto che in History dite "Dal 2001".
const stats = [
    ...
    <section id="identity" className="py-24 bg-brand-light">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          ...
          {/* Qui abbiamo inserito il vostro VERO posizionamento strategico */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <p className="text-xl text-brand-gray font-light leading-relaxed">
              ...
              Avere esperti di infrastruttura, sviluppatori software, specialisti di sicurezza e intelligenza artificiale nello stesso team è il nostro più grande vantaggio.
              Ci permette di muoverci con un'agilità introvabile altrove, gestendo progetti complessi in <span className="font-medium text-brand-dark">Pubblica Amministrazione</span> e vantando un'esperienza rara in <span className="font-medium text-brand-dark">ambito Navale</span>.
            </p>
          </motion.div>
