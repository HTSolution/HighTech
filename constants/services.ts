export const SERVICES_CONTENT = {
  philosophy: {
    tag: "Nostra Filosofia",
    quote: "Cerchiamo soluzioni visionarie dove altri vedono limiti"
  },
  header: {
    title: "I Nostri",
    subtitle: "Servizi",
    claim: "Soluzioni tecnologiche su misura per il B2B"
  }
};
...
export const SERVICES = [
  {
    ...
    metrics: [
      { label: "Uptime Garantito", value: "99.99%" },
      { label: "SLA Intervento", value: "< 2h" }
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "Cost Saving Medio", value: "30%" },
      { label: "Migrazione", value: "Zero-Downtime" }
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "Threat Detection", value: "< 1ms" },
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "Release Cycles", value: "Weekly" }
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "Soddisfazione Clienti", value: "4.9/5" },
      { label: "First Response", value: "< 30m" }
    ],
