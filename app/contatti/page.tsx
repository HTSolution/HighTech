            ...
            >
              ...
              <div className="relative z-10">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="inline-flex items-center justify-center w-full px-8 py-5 bg-brand-blue text-white rounded-full font-bold uppercase text-xs tracking-[0.2em] hover:bg-white hover:text-brand-dark transition-all shadow-lg shadow-brand-blue/20 mb-8"
                >
